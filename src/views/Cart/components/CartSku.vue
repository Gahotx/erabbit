<template>
  <div class="cart-sku" ref="target">
    ...
    <div class="layer" v-if="visible">
      ...
      <xtx-sku @change="changeSku" :skuId="skuId" v-else :goods="goods" />
      <XtxButton
        @click="submit"
        v-if="!loading"
        type="primary"
...
.cart-sku {
  ...
  .layer {
    ...
    z-index: 10;
    width: 400px;
    border: 1px solid var(--xtx-color);
    ...
    &::before {
      ...
      width: 12px;
      height: 12px;
      border-left: 1px solid var(--xtx-color);
      border-top: 1px solid var(--xtx-color);
      position: absolute;
      left: 12px;
      top: -8px;
      background: #fff;
